...
swimmers.genKIFMM([1e-2, 1],'parThreads',4,'GPU',1,'GMRES',1);
...
pfunc = @(x) MobilityPrecon(x, swimmers);

x = gmres(afunc, [vel-shear;zeros(6*swimmers.swimmerNo(),1)],[],1e-4,10,pfunc);
